...
namespace CopQuiz
{
    class Program
    {
        ...
        static bool IsValid(char[] answer)
        {
            // Q2
            if (
                !(
        ...
        static IOrderedEnumerable<KeyValuePair<char, int>> GetSelectionCount(char[] answer)
        {
        ...
        static bool IsAdjacent(char first, char second)
        {
